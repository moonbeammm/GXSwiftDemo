...
final class CellsBuilderTests: XCTestCase {
    ...
    func testInit11() {
        ...
        let builders = [
            CellsBuilder(cs),
            CellsBuilder.buildArray(cs)
        ]

        for builder in builders {
            let cells = builder.buildCells()

            XCTAssertEqual(cells.count, cs.count)
            XCTAssertEqual(cells[0].component(as: A.Component.self), cs[0])
            XCTAssertEqual(cells[1].component(as: A.Component.self), cs[1])
            XCTAssertEqual(cells[2].component(as: A.Component.self), cs[2])
            XCTAssertEqual(cells[3].component(as: A.Component.self), cs[3])
            XCTAssertEqual(cells[4].component(as: A.Component.self), cs[4])
            XCTAssertEqual(cells[5].component(as: A.Component.self), cs[5])
            XCTAssertEqual(cells[6].component(as: A.Component.self), cs[6])
            XCTAssertEqual(cells[7].component(as: A.Component.self), cs[7])
            XCTAssertEqual(cells[8].component(as: A.Component.self), cs[8])
            XCTAssertEqual(cells[9].component(as: A.Component.self), cs[9])
        }
    }
}
